...
class Game:
    ...
    def _draw_fog(self, board):
        """Vue 'grille adverse' : brouillard de guerre.
    ...
    def draw(self):
        ...
        if self.phase == "PLACEMENT":
            ...
            ent = [str(i + 1) for i, s in enumerate(self.boards[self.current].ships)
    ...
    def on_click(self, pos):
        ...
        res = target.fire(cell)  # <-- ici a lieu la mesure quantique (cote modele)
        ...
        note = " | Intrication : le navire lie est aussi fige !" if target.last_entangled else ""
